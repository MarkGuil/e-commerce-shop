...
<body>
  ...
  <div class="sidenav"><br>
    ...
    <a href="statprod.php" class="active"><img src="../images/order.png" style="height:30px; width:30px;">&nbsp;&nbsp;<b>Product Status</b></a>
  ...
  <div class="main">
    ...
    <span style="color:grey; margin-left:3%; font-size:20px;">Dashboard / Product Status</span><br><br>
    ...
    <?php
    $sql = "SELECT statID FROM prodstatus ORDER BY statID";
    ...
    <div style="text-align:center; margin-top:-25px; font-size:18px;">
      Total Number of Status: <font color="green" style="font:bold 22px 'Aleo';"><?php echo $rowcount; ?> <a href="statprod.php"><img src="../images/refresh.png" id="refresh" style="height:20px; width:20px; margin-top:-5px;"></a></font>
      <a rel="facebox" href="modal/addstat.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;">Add Status</button></a>
    </div>
    <hr>
        ...
        ?>
              <tr class="record">
                ...
                <td style="text-align: center;">
                  <a rel="facebox" title="Click to edit the product" href="modal/editsts.php?id=<?php echo $statID; ?>">
