...
if (isset($_POST["limitOption"])) {
  $_SESSION['limitPS'] = $_POST['limitOption'];
  header('location: statprod.php');
}
$limit = isset($_SESSION['limitPS']) ? $_SESSION['limitPS'] : 10;
$page = isset($_GET['page']) ? $_GET['page'] : 1;
$start = ($page - 1) * $limit;

$sql1 = "SELECT * FROM prodstatus LIMIT $start, $limit";
$resultprod = mysqli_query($link, $sql1);

$sql2 = "SELECT * FROM prodstatus";
...
<body>
  <div class="d-flex flex-nowrap min-vh-100 p-0 m-0">
    ...
    <div class="sidenav d-flex flex-column flex-shrink-0 mt-0 p-3 top-0 bottom-0" style="width: 200px;">
      ...
      <a href="statprod.php" class="active d-flex py-3">
    ...
    <div class="position-relative flex-fill p-0 m-0">
      ...
      <div class="main mb-3">
        <div class="d-flex fs-2 align-items-center mx-2 py-2 mb-3 border-bottom border-secondary">
          <i class='bx bxs-dashboard me-2'></i> <b>Dashboard / Product Status</b>
        </div>
        <div class="px-5">
          ...
          <div style="text-align:center; margin-top:-25px; font-size:18px;">
            ...
            <button type="button" class="btn btn-success float-end" data-bs-toggle="modal" data-bs-target="#addStatusModal">Add Status</button>
          </div>
          <hr>
          <span><b>Product Status</b></span>
          <div class="row mt-3">
            <div class="col-sm-12 col-md-8">
              <div aria-label="...">
                <ul class="pagination">
                  <li class="page-item">
                    <a class="page-link <?php if ($previous <= 0) echo 'disabled' ?>" href="statprod.php?page=<?= $previous ?>">Previous</a>
                  </li>
                  <?php for ($i = 1; $i <= $pages; $i++) : ?>
                    <li class="page-item">
                      <a class="page-link <?php if ($page == $i) echo 'active' ?>" href="statprod.php?page=<?= $i ?>"><?= $i ?></a>
                    </li>
                  <?php endfor ?>
                  <li class="page-item">
                    <a class="page-link <?php if ($next > $pages) echo 'disabled' ?>" href="statprod.php?page=<?= $next ?>">Next</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
            ...
            <tbody>
              ...
              ?>
                  <tr class="record">
                    ...
                    <td style="text-align: center;">
                      <button type="button" class="btn btn-link" data-bs-toggle="modal" data-bs-target="#editStatusModal" onclick="editStatus('<?php echo $statID; ?>')">
                        <img src="../images/edit.png" style="height:20px; width:20px;">
                      </button>
                      <hr>
                      <a href="#" id="<?php echo $statID ?>" class="delbutton" title="Click to Delete the product">
              ...
              <?php
                ...
                echo "<tr><td colspan='3' class='text-center'>No records were found.</tr></td>";
              }
  ...
  <?php include 'modal/addstat.php'; ?>
  <?php include 'modal/editsts.php'; ?>
  <script src="js/editStatus.js"></script>
  <script type="text/javascript">
