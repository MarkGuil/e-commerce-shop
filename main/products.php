...
if (isset($_POST["limitOption"])) {
  $_SESSION['limitNFP'] = $_POST['limitOption'];
  header('location: products.php');
}
$limit = isset($_SESSION['limitNFP']) ? $_SESSION['limitNFP'] : 10;
    ...
    <div class="sidenav d-flex flex-column flex-shrink-0 mt-0 p-3 top-0 bottom-0" style="width: 200px;">
      ...
      <div class="collapse" id="collapseExample">
        <div class="card card-body bg-transparent border-0 py-1 pe-0">
          ...
          <a href="products.php" class="active d-flex py-3">
    ...
    <div class="position-relative flex-fill p-0 m-0">
      ...
      <div class="main mb-3">
        <div class="d-flex fs-2 align-items-center mx-2 py-2 mb-3 border-bottom border-secondary">
          <i class='bx bxs-dashboard me-2'></i> <b>Dashboard / Products - non featured</b>
        </div>
        ...
        <div class="px-5">
          ...
          <div style="text-align:center; margin-top:-25px; font-size:18px;3">
          ...
          <span><b>Showing non featured products</b></span>
          <div class="row mt-3">
            <div class="col-sm-12 col-md-8">
              <div aria-label="...">
                <ul class="pagination">
                  <li class="page-item">
                    <a class="page-link <?php if ($previous <= 0) echo 'disabled' ?>" href="products.php?page=<?= $previous ?>">Previous</a>
                  </li>
                  <?php for ($i = 1; $i <= $pages; $i++) : ?>
                    <li class="page-item">
                      <a class="page-link <?php if ($page == $i) echo 'active' ?>" href="products.php?page=<?= $i ?>"><?= $i ?></a>
                    </li>
                  <?php endfor ?>
                  <li class="page-item">
                    <a class="page-link <?php if ($next > $pages) echo 'disabled' ?>" href="products.php?page=<?= $next ?>">Next</a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <tbody>
              ...
              ?>
                  <tr class="record">
                    ...
                    <td><?= $category; ?></td>
                    <td><?= $prodDesc; ?></td>
                    <td style="text-align: center;"><img src="<?= $prodImg; ?>" style="height100px; width:100px;"></td>
                    <td><?= "P " . $price; ?></td>
                    <td><?= $aQuantity ?></td>
                    <td><?= "Availabe voucher: " . $voucher . "<br>Amount: P " . $voucherval ?></td>
                    <td style="text-align: center;">
                      <button type="button" class="btn btn-link" data-bs-toggle="modal" data-bs-target="#editProductModal" onclick="editProduct('<?= $prodID; ?>')">
                        <img src="../images/edit.png" style="height:20px; width:20px;">
                      </button>
                      <hr>
                      <a href="#" id="<?= $prodID ?>" class="delbutton" title="Click to Delete the product">
