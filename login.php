...
<body>
	...
	<div class="container text-black card border" id="opacity" style="max-width: 700px; margin-top:5%;"><br>
		...
		?>
		<form form action="php/loginProcess.php" method="post" enctype="multipart/form-data">
			...
			<p align="center">Don't have account? <a href="registration.php">Sign Up</a></p>
		</form>
	</div>
</body>
